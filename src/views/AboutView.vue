    ...
    <article data-page="about">
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="rounded-full mb-3 fadein-up object-cover object-center w-80 h-80" :src="aboutImage" alt="Foto"> </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Femas Alfaridzi. Student of the Information Technology study program at Brawijaya University, who has an
            interest in technology, innovation and self-development.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; Actively participates in campus
            activities and organizations. Career in Community Development and Digital Marketing.
          </p>
        </div>
